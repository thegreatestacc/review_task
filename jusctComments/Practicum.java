...
/**
 * 1. Вынести логику из main-метода в отдельный метод.
 * 2. Заменить тип поля expenses с массива на коллекцию.
 * 3. Конструкцию if-else заменить на switch-case.
 * 4. Из параметров метода saveExpense объект типа Scanner вынести в тело метода.
 * 5. Можно использовать Command pattern.
 */
...
public class Practicum {
    public static void main(String[] args) {
        ...
        Advice dinnerAdvisor = new Advice();
